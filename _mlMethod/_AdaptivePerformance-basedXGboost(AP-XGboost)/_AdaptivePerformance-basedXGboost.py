...
class DynamicXGBoost:
    def __init__(self, initial_data_path, selected_columns, label_column,
        ...
        self.train_test_metrics_history = []
    ...
    def print_detailed_metrics_report(self):
        ...
        for i, metrics_info in enumerate(self.train_test_metrics_history[-3:]):
    ...
    def print_drift_report(self):
        ...
        for i, drift_info in enumerate(self.drift_detection_history[-5:]):
